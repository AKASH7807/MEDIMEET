          ...
          <div className="flex flex-col md:flex-row justify-between gap-4">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <div className="flex items-center mt-2 text-[12px] text-muted-foreground">
                  <Calendar className="h-4 w-4 mr-1" />
                  <span>{formatDateTime(appointment.startTime)}</span>
                </div>
                <div className="flex items-center mt-1 text-[12px] text-muted-foreground">
            ...
            {appointment.patientDescription && (
              <div className="space-y-1">
                ...
                <div className="p-3 rounded-md bg-muted/20 border border-emerald-900/20">
                  <p className="text-[12px] text-white whitespace-pre-line">
                    {appointment.patientDescription}
                  </p>
                </div>
              </div>
              ...
              {userRole === "DOCTOR" && action === "notes" ? (
                <div className="space-y-1">
                  <Textarea
                    ...
                    className="bg-background border-emerald-900/20 min-h-[50px] text-[12px]"
                  />
                ...
                <div className="p-3 rounded-md bg-muted/20 border border-emerald-900/20 min-h-[40px]">
                  {appointment.notes ? (
